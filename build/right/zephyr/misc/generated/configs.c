...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PERIPHERAL_STACK_SIZE, 650);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_LEELOO_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_TRIGGER_GLOBAL_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_TRIGGER, 1);
